...
const TOOLS = [
  {
    ...
    title: 'Analyze',
    text: 'Keep an eye on your assets and the price change in real time. It is a long established fact that a reader.',
  },{
    ...
    title: 'Demo',
    text: 'In addition to Live trading, Bitsgap allows you to practice in DEMO mode. ',
  },
];
    ...
    return (
      <div className='tools-wrapper'>
        ...
        <div className='tools'>
          ...
          {TOOLS.map((item, i) => (
            <ToolBlock key={i} img={item.img} title={item.title} text={item.text} />
          ))}
